        ...
        <header class="header">
            <div class="header-container">
                ...
                <div class="mypage-icons">
                    <div class="icons">
                        <!-- 강사 아이콘 -->
                        <button type="button" class="mypage-icon" onclick="location.href='${pageContext.request.contextPath}/teacher-page'">
                ...
                <div class="category-slides" id="categorySlides">
                    <div class="category-slide">
                        ...
                        <button class="category-btn" data-category="painting">
                            <img src="${pageContext.request.contextPath}/static/img/category-painting-icon.png"
                                alt="painting">
                            그림
                        </button>
                        <button class="category-btn" data-category="pottery">
                            <img src="${pageContext.request.contextPath}/static/img/category-pottery-icon.png"
                                alt="도자기">
                            도자기
                        </button>
                    ...
                    <div class="category-slide">
                        <button class="category-btn" data-category="metalworking">
                            <img src="${pageContext.request.contextPath}/static/img/category-metalworking-icon.png"
                                alt="금속공예">
                            금속공예
                        </button>
                        <button class="category-btn" data-category="bookmaking">
                            <img src="${pageContext.request.contextPath}/static/img/category-bookmaking-icon.png"
                                alt="책만들기">
                            책만들기
                        </button>
                    </div>
            ...
            <div class="mobile-menu-modal-content">
                ...
                <ul>
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/student-page">학생 마이페이지</a></li>
                    </ul>
            </div>
        </div>
        ...
        <div id="joinModal" class="modal">
            <div class="modal-content">
                ...
                <form id="joinForm" method="post" action="${pageContext.request.contextPath}/signup">
                    ...
                    <input type="password" id="joinPasswordConfirm" name="passwordConfirm" placeholder="비밀번호 확인"
                        required><br>
                    영문, 숫자 포함 8~20자를 입력해 주세요<br>
